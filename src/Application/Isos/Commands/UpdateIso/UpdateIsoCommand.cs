...
public record UpdateIsoCommand(Ulid Id, string Number, string Nameplate, char Revision, string System, string Class, string? Atest, string? KzmNumber, DateOnly? KzmDate, Ulid DrawingId, Ulid ChemicalProcessId) : IRequest
{
}

public class UpdateIsoCommandValidator : AbstractValidator<UpdateIsoCommand>
{
    public UpdateIsoCommandValidator(IIsoService isoService, IDrawingService drawingService, IChemicalProcessService chemicalProcessService)
    {
        RuleFor(x => x.Id)
            .NotNull()
            .NotEmpty()
...
public class UpdateIsoCommandHandler : IRequestHandler<UpdateIsoCommand>
{
    ...
    {
        var (id, number, nameplate, revision, system, @class, atest, kzmNumber, kzmDate, drawingId, chemicalProcessId) = request;
        ...
        var updated = _factory.Create(id, number, nameplate, revision, system, @class, atest, kzmNumber, kzmDate, drawing, chemicalProcess);
