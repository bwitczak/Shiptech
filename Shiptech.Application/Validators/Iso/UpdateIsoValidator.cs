...
public class UpdateIsoValidator : AbstractValidator<UpdateIso>
{
    public UpdateIsoValidator(IIsoReadService service)
    {
        RuleFor(x => x.Id)
            .NotNull()
            .NotEmpty()
        ...
        RuleFor(x => x.System)
            .NotNull()
            .NotEmpty()
            .WithErrorCode("UPDATE_UPDATE_ISO_400_SYSTEM")
